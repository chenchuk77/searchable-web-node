...
docker build -t chenchuk77/node-web-app .
...
#docker run --name matkonim-server -p 8811:8080 -d chenchuk77/node-web-app
docker run --name matkonim-server -p 80:8080 -d chenchuk77/node-web-app
